...
(1,'admin','admin','idferypurnama@gmail.com'),
(2,'operator1','operator1','-'),
(3,'operator2','operator2','-'),
(4,'operator3','operator3','-'),
...
insert  into `pasien`(`id_pasien`,`no_rm`,`no_kk`,`nik`,`nama`,`tgl_lhr`,`jk`,`alamat`,`layanan`,`no_bpjs`,`no_hp`,`ket`) values 
